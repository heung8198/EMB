...
def run(estimation_model, classification_model, label_file, camera_id, width, height):
    ...
    while cap.isOpened():
        ...
        # 각 랜드마크의 좌표를 추출
        left_shoulder_y = pose_detector.data.keypoints_with_scores[5][0] # 왼쪽 어깨 y 좌표
        right_shoulder_y = pose_detector.data.keypoints_with_scores[6][0] # 오른쪽 어깨 y 좌표
        left_wrist_y = pose_detector.data.keypoints_with_scores[9][0] # 왼쪽 손목 y 좌표
        right_wrist_y = pose_detector.data.keypoints_with_scores[10][0] # 오른쪽 손목 y 좌표
